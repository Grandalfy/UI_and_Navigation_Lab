...
public class BlogRecyclerViewAdapter extends RecyclerView.Adapter<BlogRecyclerViewAdapter.BlogViewHolder> {
    ...
    private final CardStatusViewModel mCardStatusModel;

    public BlogRecyclerViewAdapter(FragmentActivity activity, List<BlogPost> items) {
        this.mBlogs = items;
        mCardStatusModel = new ViewModelProvider(activity).get(CardStatusViewModel.class);
    }
    ...
    public class BlogViewHolder extends RecyclerView.ViewHolder {
        ...
        private void handleMoreOrLess(final View button) {
            mCardStatusModel.put(mBlog, !mCardStatusModel.get(mBlog));
